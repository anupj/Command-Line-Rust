...
fn multiple_files_n0() -> TestResult {
    run(&["-n", "0", TEN, EMPTY, ONE, THREE, TWO], "tests/expected/all.n0.out")
}

#[test]
fn multiple_files_n1() -> TestResult {
    run(&["-n", "1", TEN, EMPTY, ONE, THREE, TWO], "tests/expected/all.n1.out")
}
...
fn multiple_files_n3() -> TestResult {
    run(&["-n", "3", TEN, EMPTY, ONE, THREE, TWO], "tests/expected/all.n3.out")
}
...
fn multiple_files_c0() -> TestResult {
    run(&["-c", "0", TEN, EMPTY, ONE, THREE, TWO], "tests/expected/all.c0.out")
}

#[test]
fn multiple_files_c3() -> TestResult {
    run(&["-c", "3", TEN, EMPTY, ONE, THREE, TWO], "tests/expected/all.c3.out")
}
