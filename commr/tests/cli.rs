...
fn file1_file2_123() -> TestResult {
    run(&["-123", FILE1, FILE2], "tests/expected/file1_file2.123.out")
}
...
fn file1_file2_1_i() -> TestResult {
    run(&["-1", "-i", FILE1, FILE2], "tests/expected/file1_file2.1.i.out")
}

// --------------------------------------------------
#[test]
fn file1_file2_2_i() -> TestResult {
    run(&["-2", "-i", FILE1, FILE2], "tests/expected/file1_file2.2.i.out")
}

// --------------------------------------------------
#[test]
fn file1_file2_3_i() -> TestResult {
    run(&["-3", "-i", FILE1, FILE2], "tests/expected/file1_file2.3.i.out")
}

// --------------------------------------------------
#[test]
fn file1_file2_1_2_i() -> TestResult {
    run(&["-12", "-i", FILE1, FILE2], "tests/expected/file1_file2.12.i.out")
}

// --------------------------------------------------
#[test]
fn file1_file2_2_3_i() -> TestResult {
    run(&["-23", "-i", FILE1, FILE2], "tests/expected/file1_file2.23.i.out")
}

// --------------------------------------------------
#[test]
fn file1_file2_13_i() -> TestResult {
    run(&["-13", "-i", FILE1, FILE2], "tests/expected/file1_file2.13.i.out")
}

// --------------------------------------------------
#[test]
fn file1_file2_123_i() -> TestResult {
    run(&["-123", "-i", FILE1, FILE2], "tests/expected/file1_file2.123.i.out")
}
...
fn file1_file2_delim() -> TestResult {
    run(&[FILE1, FILE2, "-d", ":"], "tests/expected/file1_file2.delim.out")
}
