...
fn type_f_path_a() -> TestResult {
    run(&["tests/inputs/a", "-t", "f"], "tests/expected/type_f_path_a.txt")
}
...
fn type_f_path_d() -> TestResult {
    run(&["tests/inputs/d", "--type", "f"], "tests/expected/type_f_path_d.txt")
}
...
fn type_d_path_a() -> TestResult {
    run(&["tests/inputs/a", "-t", "d"], "tests/expected/type_d_path_a.txt")
}
...
fn type_d_path_d() -> TestResult {
    run(&["tests/inputs/d", "--type", "d"], "tests/expected/type_d_path_d.txt")
}
...
fn type_f_l() -> TestResult {
    run(&["tests/inputs", "-t", "l", "f"], "tests/expected/type_f_l.txt")
}

// --------------------------------------------------
#[test]
fn name_csv() -> TestResult {
    run(&["tests/inputs", "-n", ".*[.]csv"], "tests/expected/name_csv.txt")
}
...
fn unreadable_dir() -> TestResult {
    ...
    let cmd = Command::cargo_bin(PRG)?.arg("tests/inputs").assert().success();
